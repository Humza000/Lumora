        ...
        <div className="container mx-auto px-4 md:px-6 max-w-3xl">
          ...
          <Accordion type="single" collapsible className="w-full">
            {[
              ...
              { q: "Do you provide ongoing maintenance?", a: "Yes, we offer monthly and yearly maintanence packages for ongoing technical support, security updates, bug fixes, client requests and analytics reviews." },
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="pt-8 border-t border-background/10 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-background/50">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="#" aria-label="TikTok" className="text-background/50 hover:text-white transition-colors">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
